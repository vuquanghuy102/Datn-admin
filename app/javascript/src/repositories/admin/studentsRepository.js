...
export default {
  ...
  create(params) {
    return Repository.post(
      `https://localhost:8243/create_student/1.0?dob=${params.dob}&first_name=${params.fp_user.first_name}&last_name=${params.fp_user.last_name}&class_name=${params.class_name}&email=${params.fp_user.email}&password=${params.fp_user.password}&program=${params.program}&password_confirmation=${params.fp_user.password_confirmation}`, params, {
        headers: headers
    });
  },
  update(params) {
