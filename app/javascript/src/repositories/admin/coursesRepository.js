...
export default {
  ...
  create(params) {
    return Repository.post(
      `https://localhost:8243/create_course/1.0?course_code=${params.course_code}&max_slot=${params.max_slot}&status=${params.status}&subject_id=${params.subject_id}`, params, {
        headers: headers
    });
  },
  update(params) {
